...
import { Play, Stop, ShareNetwork, Eye, Dna, DownloadSimple, UploadSimple } from '@phosphor-icons/react';
        ...
        <div className="flex h-full w-full relative">
            ...
            <div className="flex-1 h-full relative bg-black/90">
                <div className="absolute top-4 right-4 z-20 flex gap-2">
                    ...
                    <Button onClick={handleImportClick} variant="ghost" size="icon" title="Import Blueprint">
                        <UploadSimple />
                    </Button>
